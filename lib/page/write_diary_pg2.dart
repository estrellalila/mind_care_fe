...
//   const WriteEmotion({Key? key}) : super(key: key);
//
//   @override
...
//   // Future<void> sendMoodRequestToServer(String inputText) async {
//   //   try { // url 바꿔야 함
//   //     String url = "http://34.64.58.86:3000/AImood?input=${emotionTextController.text}";
...
//   //       setState(() {
//   //         moodName = responseData['Mood_Name'];
//   //         moodId = responseData['Mood_ID'];
//   //       });
//   //     } else {
//   //       // 에러 처리
...
//   //       Map<String, dynamic> responseData = json.decode(response.body);
//   //       setState(() {
//   //         moodValue = responseData['Mood_value'];
//
//   //       });
//   //     } else {
//   //       // 에러 처리
...
//   //   sendMoodRequestToServer(emotionTextController.text);
//   //   sendAIRequestToServer(emotionTextController.text);
//   //   _updateLocalMood();
//   //   uploadDiaryToServer();
//   //   modifyDiary(context);
//   // }
